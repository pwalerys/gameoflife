...
class gol_test(unittest.TestCase):
    ...
    def test_next_step_will_leave_left_corner_upper_alive_when_only_two_cells_are_alive(self):
    ...
    def test_next_step_will_leave_alive_left_upper_corner_when_all_surrounding_cells_are_alive(self):
        self.board.set_alive(0, 0)
